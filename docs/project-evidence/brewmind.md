...
| --- | --- | --- | --- |
| Implemented workflow | `BrewMind-AI/lib/ingest/ingestDocument.ts` | Source inspected; runtime and personal ownership unverified | Described as repository capability. |
| Supporting component or scope | `BrewMind-AI/lib/rag/retrieve.ts` | Implementation or source documentation; measured impact unverified | Benefit stated as functional outcome. |
