# hotel-social-n8n evidence

| Claim | Evidence | Confidence / boundary | Public wording |
| --- | --- | --- | --- |
| Implemented workflow | `n8n_tobi/backups/Hotel_Social_Media_EtBfnzIS7iH8yRQP_backup_2026-07-31.json` | Source inspected; runtime and personal ownership unverified | Described as repository capability. |
