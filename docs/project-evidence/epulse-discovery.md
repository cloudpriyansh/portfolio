# epulse-discovery evidence

| Claim | Evidence | Confidence / boundary | Public wording |
| --- | --- | --- | --- |
| Implemented workflow | `E-Pulse/epulse-hermes-agent/README.md` | Source inspected; runtime and personal ownership unverified | Described as repository capability. |
| Supporting component or scope | `E-Pulse/epulse-hermes-agent/app/services` | Implementation or source documentation; measured impact unverified | Benefit stated as functional outcome. |
